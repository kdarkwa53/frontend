                                ...
                                >
                                    <div className={Styles.sectionBox}>
                                        ...
                                        <div className={Styles.itemRow}>
                                            ...
                                            <span style={{ fontWeight: "bold" }} >{currencies[sourceWallet?.currency_id]?.ISO ? ` (${currencies[sourceWallet?.currency_id]?.ISO})` : ""}
                                            </span>
                                            </div>
                                            <div className={Styles.inputContainer}>
                                                <Form.Item
                                                ...
                                                >
                                                    <Input onChange={handleAmountChange} prefix={currencies[defaultWallet?.currency_id].ISO} width="100%" size="large" name='amount' type="number" />
                                                </Form.Item>
                                            </div>
                                        </div>
                                        <div className={Styles.itemRow}>
