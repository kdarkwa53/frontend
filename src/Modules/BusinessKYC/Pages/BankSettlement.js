                        ...
                        <Col xs={24} sm={24} md={32} lg={32} xl={32}>
                            ...
                            >
                                ...
                                <Radio.Group style={{ width: '100%' }}>
                                    <Row gutter={[32, 16]}>
                                        <Col span={8}>
                                            <Radio className={Styles.checkboxContainer} style={{ padding: '0.7em' }} value="ach">ACH</Radio>
                                        </Col>
                                        <Col span={8}>
                                            <Radio className={Styles.checkboxContainer} style={{ padding: '0.7em' }} value="wire">Wire</Radio>
                                        </Col>
                                        <Col span={8}>
                                            <Radio className={Styles.checkboxContainer} style={{ padding: '0.7em' }} value="draft">Draft</Radio>
                                        </Col>
                                        <Col span={8}>
                                            <Radio className={Styles.checkboxContainer} style={{ padding: '0.7em' }} value="check">Check</Radio>
                                        </Col>
                                        <Col span={8}>
                                            <Radio className={Styles.checkboxContainer} style={{ padding: '0.7em' }} value="electronic_bill_payment">Electronic bill payment</Radio>
                                        </Col>
                                        <Col span={8}>
                                            <Radio className={Styles.checkboxContainer} style={{ padding: '0.7em' }} value="checkmatic">Checkmatic</Radio>
                                        </Col>
                                        <Col span={8}>
                                            <Radio className={Styles.checkboxContainer} style={{ padding: '0.7em' }} value="reverse_wire_drawdown">Reverse wire drawdown</Radio>
                                        </Col>
